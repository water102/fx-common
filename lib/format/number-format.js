...
export function numberFormat(value, lengthOfDecimal = 3, lengthOfWholePart = 3, sectionsDelimiter = ',', decimalDelimiter = '.') {
    ...
    let result = (decimalDelimiter
        ...
        : num).replace(new RegExp(re, 'g'), '$&' + sectionsDelimiter);
